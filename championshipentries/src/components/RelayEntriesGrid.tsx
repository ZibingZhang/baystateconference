...
function RelayEntriesGrid({
  ...
  const { processRow: processSeedTimeRow, snackbar: seedTimeSnackbar } = useSeedTimeColumn<RelayEntry>()
  ...
  return (
    <>
      ...
      <CsvExportDialog
        ...
        headers={['Event', 'Relay', 'Athlete 1', 'Athlete 2', 'Athlete 3', 'Athlete 4', 'Seed Time']}
