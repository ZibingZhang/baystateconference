...
function parseResultCommon(body: string, dateStart: number): Omit<Hy3Result, 'padTime' | 'buttonTimes' | 'backup4Time' | 'reactionTime' | 'reactionTimes' | 'altTimeCode'> {
...
export function parseHy3(text: string, options: ParseHy3Options = {}): Hy3File {
  ...
  const state: ParserState = { file: emptyFile(), currentTeam: undefined, currentEntry: undefined, lastResult: undefined }
