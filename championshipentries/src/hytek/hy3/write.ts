...
function serializeA1(file: Hy3File): string {
  ...
  writeField(
    ...
    59,
    17,
    file.fileInfo.dateCreated ? formatHy3DateTime(file.fileInfo.dateCreated) : "",
  );
...
function serializeB2(file: Hy3File): string {
  ...
  writeField(
    ...
    100,
    7,
    file.meet.unknownFeeField !== undefined ? file.meet.unknownFeeField.toFixed(2) : "",
    "right",
  );
...
function serializeResultCommon(buf: string[], result: Hy3Result, dateStart: number): void {
  ...
  writeField(
    ...
    39,
    8,
    result.buttonTimes?.[0] !== undefined ? result.buttonTimes[0].toFixed(2) : "",
    "right",
  );
  writeField(
    buf,
    47,
    8,
    result.buttonTimes?.[1] !== undefined ? result.buttonTimes[1].toFixed(2) : "",
    "right",
  );
  writeField(
    buf,
    55,
    8,
    result.buttonTimes?.[2] !== undefined ? result.buttonTimes[2].toFixed(2) : "",
    "right",
  );
  ...
  writeField(
    ...
    75,
    8,
    result.backup4Time !== undefined ? result.backup4Time.toFixed(2) : "",
    "right",
  );
...
function serializeE2(result: Hy3Result): string {
  ...
  writeField(
    ...
    83,
    5,
    result.reactionTime !== undefined ? result.reactionTime.toFixed(2) : "",
    "right",
  );
    ...
    for (const swimmer of team.swimmers) {
      ...
      for (const entry of file.individualEntries) {
        ...
        for (const result of entry.results)
          bodies.push(...serializeResultAndExtras(result, "individual"));
      }
    }
  }
