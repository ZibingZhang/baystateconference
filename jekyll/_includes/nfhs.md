{%- comment -%}
  Shared "About > NFHS" content, for every sport's page (generated by
  sport_governing_body_page_generator.rb at /<sport>/nfhs/) and for the
  sport-agnostic /about/nfhs/ (hand-written, links to the base NFHS site).
  ...
  page's own first URL segment (e.g. "/baseball/nfhs/" -> "/baseball/") -
