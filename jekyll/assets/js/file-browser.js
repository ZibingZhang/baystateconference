...
function createCopyLinkButton(anchor) {
  ...
  button.addEventListener("click", (event) => {
    ...
    // by :hover OR :focus-within — would otherwise keep it visible after the
    // mouse leaves, until something else is clicked. Blur it so hover alone
    // governs visibility again once the confirmation ends. Keyboard
